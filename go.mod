...
require (
	...
	github.com/projectdiscovery/dsl v0.0.53 // indirect
	...
	github.com/projectdiscovery/useragent v0.0.47 // indirect
	github.com/projectdiscovery/wappalyzergo v0.0.119 // indirect
