...
require (
	...
	github.com/projectdiscovery/dsl v0.0.28 // indirect
	...
	github.com/projectdiscovery/rawhttp v0.1.24 // indirect
	github.com/projectdiscovery/retryablehttp-go v1.0.33 // indirect
