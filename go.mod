...
require (
	...
	github.com/projectdiscovery/dsl v0.2.7 // indirect
	...
	github.com/projectdiscovery/useragent v0.0.76 // indirect
	github.com/projectdiscovery/wappalyzergo v0.1.25 // indirect
