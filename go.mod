...
require (
	...
	github.com/projectdiscovery/dsl v0.0.39 // indirect
	github.com/projectdiscovery/fastdialer v0.0.52 // indirect
	...
	github.com/projectdiscovery/ratelimit v0.0.25 // indirect
	github.com/projectdiscovery/rawhttp v0.1.34 // indirect
